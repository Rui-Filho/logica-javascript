/* Composição de funções + Abstração real   */
...
filtrar(
adicionarCampo(temporada, item => item.superLiga+item.copaDoBrasil+item.superCopa), item => item.totalNacional>=40
), "totalNacional"
)
